  ...
  <main>
    ...
    <div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
      <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
        <div>
          <div>
            <img class="h-11 w-auto" src="../assets/bdd.svg" alt="Workflow">
          </div>
          <div class="mt-20">
            <div>
              <a href="#" class="inline-flex space-x-4">
                ...
                <span class="inline-flex items-center text-sm font-medium text-rose-500 space-x-1">
                  <span>Just shipped this landing page</span>
                </span>
              </a>
            </div>
            <div class="mt-6 sm:max-w-xl">
              <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
                Community for programmers at bitmesra
              </h1>
              <p class="mt-6 text-xl text-gray-500">
                We also try to get them internships and placement opportunities at reputed startups.
              </p>
            </div>
      ...
      <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
        <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          ...
          <div class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
            <img class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none" src="../assets/bdd-mock.png" alt="">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="relative">
            <div class="sm:text-center">
              ...
              <p class="mt-6 mx-auto max-w-2xl text-lg text-rose-100">
                Mostly designed and developed by final year folks at bit mesra and funded by our alumni.
              </p>
            </div>
  ...
  <footer class="mt-24 bg-gray-900 sm:mt-12">
    <div class="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="mt-8 flex justify-center space-x-6">
        ...
        <a href="https://www.instagram.com/ietbitmesra" class="text-gray-400 hover:text-gray-300">
        ...
        <a href="https://github.com/ietbitmesra" class="text-gray-400 hover:text-gray-300">
      ...
      <p class="mt-8 text-center text-base text-gray-400">
        &copy; 2021 bitmesradotdev. All rights reserved.
      </p>
    </div>
  </footer>
</div>
